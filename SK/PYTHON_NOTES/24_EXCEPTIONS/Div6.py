...
#Div6.py-----This Program Defined by KVR Programmer in the Year 2024 Aug 28th
...
except IndexError: # Specific Except block  default except block
	print("\tCheck the Index and Move!!!")
